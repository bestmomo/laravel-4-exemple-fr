  ...
  <body>
	...
	<body>
	  <div class="hero-unit center">
	  	<hr>
	    <h1>Page interdite <small><font face="Tahoma" color="red">Erreur 403</font></small></h1>
	    <br>
	    <p>La page que vous demandez est protégée, vous ne disposez pas des droits suffisants pour la consulter.</p>
